  ...
  return (
    ...
    >
      <div className=" flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className=" flex justify-center items-center  rounded-lg p-4 bg-gray-800 ">
          <form
          ...
          >
            ...
            <input
              type="text"
              name="name"
              className=" p-2 mb-3  bg-gray-600 rounded-md text-white focus:outline-none"
            />
            ...
            <input
              type="text"
              name="email"
              className=" p-2 mb-10  bg-gray-600 rounded-md text-white focus:outline-none"
            />
            ...
            <textarea
              name="message"
              rows="10"
              className=" p-2  bg-gray-600 rounded-md text-white focus:outline-none "
            ></textarea>
